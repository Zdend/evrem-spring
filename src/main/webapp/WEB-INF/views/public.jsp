...
<head>
    ...
    <script src="http://www.google.com/recaptcha/api.js?render=explicit" async defer></script>
...
<script type="text/javascript" src="resources/dist/js/publicbundle.js"></script>
